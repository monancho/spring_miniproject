...
public interface BoardDao {
	...
	List<BoardDto> RSVNselectList(@Param("sid")  String sid,  @Param("startRow")int startRow,@Param("endRow") int endRow);
	int RSVNcount(String sid);
